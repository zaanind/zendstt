...
def split_audio(input_file, output_path, output_basename, min_silence_duration=0.5):
    # Load audio file with Librosa
    audio, sr = librosa.load(input_file, sr=None)

    intervals = librosa.effects.split(audio, top_db=8)
...
print('Done! Predicted words are saved to', output_file)
